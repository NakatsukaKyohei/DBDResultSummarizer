...
def main():
    ...
    # キラーの画像認識
    killer_base_image = preprocessed_image_for_other[killer_location[0][1]:killer_location[1][1], killer_location[0][0]:killer_location[1][0]]
    ...
    # アドオンの画像認識
    first_addon_base_image = preprocessed_image_for_other[addon_location[0][0][1]:addon_location[0][1][1], addon_location[0][0][0]:addon_location[0][1][0]]
    second_addon_base_image = preprocessed_image_for_other[addon_location[1][0][1]:addon_location[1][1][1], addon_location[1][0][0]:addon_location[1][1][0]]
